...
interface ViewModeToggleProps {
  mode: ViewMode;
  onChangeMode: (viewMode: ViewMode) => void;
}
...
export default function ViewModeToggle({ mode, onChangeMode }: ViewModeToggleProps) {
  ...
  return (
    <>
      ...
      >
        <input type="radio" name="viewMode" checked={mode === ViewMode.TABLE} />
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
      ...
      >
        <input type="radio" name="viewMode" checked={mode === ViewMode.GRID} />
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
