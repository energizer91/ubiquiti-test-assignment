...
export default function ViewModeToggle() {
  const { viewMode, setViewMode } = useContext(DevicesContext);
  const onChangeViewModeHandler = React.useCallback(
    (mode: ViewMode) => () => {
      setViewMode(mode);
    },
    [],
        ...
        >
          <g id="List View">
            ...
            <path
              ...
              fill="currentColor"
              mask="url(#path-1-inside-1_2_756)"
            />
          </g>
        </svg>
      </label>
